...
// --- SCHEMAS (Resilient/Optional Pattern) ---
...
export type ContentOutputs = z.infer<typeof ContentOutputsSchema>;
...
export async function processTranscript(
    ...
    if (!transcript) return { success: false, error: "No se proporcionó transcripción." };
...
`
        ...
        return { success: false, error: `[${modelId}] Error: ${error.message || error.toString()}` };
    }
}
