...
export default function AdminClients() {
    ...
    const getPlanPrice = (tier: string) => {
        switch (tier?.toLowerCase()) {
            ...
            case 'growth': return '$800/mo';
            case 'seed': return '$400/mo';
            default: return '-';
        }
    };
                        ...
                        <div className="p-6">
                            ...
                            <form action={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select name="planTier" className="w-full border border-gray-200 p-2 text-sm rounded-sm focus:border-das-dark outline-none bg-white">
                                        <option value="seed">Seed (Básico)</option>
                                        <option value="growth">Growth (Estándar)</option>
                                        <option value="authority">Authority (Premium)</option>
                                    </select>
                                </div>
